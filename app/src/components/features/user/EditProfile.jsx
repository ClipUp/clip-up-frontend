	...
	return (
		<div className="sign-up-form">
			...
			<span className="input-group">
				...
				<TextInput name="email" placeholder="이메일" type="text" value={userProfile.data.email} disabled={true} />
				<label htmlFor="username">이름</label>
				<TextInput name="username" placeholder="이름" type="text" value={userProfile.data.username} disabled={true} />
